...
const MobileYouView = memo(function MobileYouView({ onOpenSettings, pendingFriendsCount = 0 }) {
  const { user } = useAuth();
    ...
    <div className="mobile-you-view">
      ...
      <nav className="mobile-you-nav">
        ...
        >
          ...
          <span>{t('mobileYou.accountSettings')}</span>
        ...
        >
          <span className="mobile-you-nav-icon">
            ...
            {pendingFriendsCount > 0 && (
              <span className="mobile-you-nav-badge">{pendingFriendsCount > 99 ? '99+' : pendingFriendsCount}</span>
            )}
          </span>
        ...
        >
          ...
          <span>{t('mobileYou.security')}</span>
          <svg className="mobile-you-nav-chevron" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            <path d="M8.59 16.59L13.17 12 8.59 7.41 10 6l6 6-6 6z" />
          </svg>
        </button>
